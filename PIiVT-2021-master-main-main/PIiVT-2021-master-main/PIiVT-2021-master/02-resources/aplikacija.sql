...
INSERT INTO `administrator` (`administrator_id`, `username`, `password_hash`, `created_at`) VALUES
	(1, 'biske', '$2b$11$8ha1Z4VzpFo1bXBPjwjmEOnP0AAnxEq2zDPjJDgg4YbvvfHZfPWwe', '2021-08-19 20:30:41'),
	(2, 'tijana', 'adsjadsjadsjadsadsj', '2021-08-19 22:01:26'),
	(3, 'aleksandar', 'FD0F8BCCEACA95FF42FA62D2F909D693DD9F42ADA1D508108DE0004F9B96B8786A050BDAC4F5015954782F81F5873CA3B86B507BC876470E9EF2AD60FAD37763', '2021-10-18 18:32:16'),
	(7, 'andrea', '$2b$11$z6MeK6RB8mLis3jOuc913.MwsXWlQJuAsQcvmWv.JBQEAgVNzMtJW', '2021-08-19 21:24:54'),
...
INSERT INTO `category` (`category_id`, `name`, `description`, `image_path`) VALUES
	(1, 'Solje', 'Solje', 'Kategorija namenjena za solje'),
	(4, 'Čase', 'Case', 'Kategorija namenjena za case', 'case.jpg'),
	(5, 'Stakla za uramljivanje', 'Kategorija namenjena za stakla za uramljivanje', 'stakla.jpg'),
	(7, '3D stakla', 'Kategorija namenjena za 3d stakla', '3d.png'),
...
INSERT INTO `manufacturer` (`manufacturer_id`, `name`, `created_at`) VALUES
	(1, 'Staklix', '2021-10-18 19:54:31'),
	(2, 'Staklo solution', '2021-10-18 19:54:43'),
	(3, 'Staklotex', '2021-10-18 19:55:18');
...
INSERT INTO `profile` (`profile_id`, `name`, `description`, `price_per_unit_area`, `manufacturer_id`, `category_id`, `status`, `created_at`) VALUES
	(1, 'Casa', 'Vinska Casa za kafice', 200.00, 1, 1, 'available', '2021-10-18 20:09:22'),
  (2, 'Staklena flasa', 'Staklena flasa', 200.00, 2, 4, 'available', '2021-10-18 20:09:22'),
	(3, 'Staklo za uramljivanje', 'Staklo za ramove', 1500.98, 3, 5, 'available', '2021-10-18 20:10:50'),
...
INSERT INTO `user` (`user_id`, `username`, `password_hash`, `created_ad`, `email`) VALUES
	(1, 'Uros Bisevac', 'biske', '$2b$11$FB0Hcsg530G.hlmJjuHLSuMS4fqSRdMnI5Y/Zq2EFWO9i/qBfUWre', '2021-10-18 19:58:15', 'uros.bisevac.17@singimail.rs'),
	(2, 'Djordje', 'djolezze', '2021-10-18 19:58:38', NULL),
	(4, 'Nikola Jovicic', 'nkl_jovicic', '$2b$11$FB0Hcsg530G.hlmJjuHLSuMS4fqSRdMnI5Y/Zq2EFWO9i/qBfUWre', '2021-10-18 19:08:06', 'tijana.radojicic.17@singimail.rs'),
	(5, 'najjaci user', '$2b$11$ktbD7eH2VzUOkUQc/QFSbeMwAMJYYtCffnasv.rFpBy4XMNgDosMW', '2021-10-18 20:03:29', NULL),
	(7, 'user123433214321', '$2b$11$nuxcQWuDTo5WaaektoIWK.x48MfVkNUUsoGHucXaozh/f17Z4nd1K', '2021-10-18 20:04:38', NULL),
	(8, 'usdas21', '$2b$11$6PhZn.HOIT39shCq3FtdyOtnMyNxEiS6nL4WHux5DOjkGuh7JfkiK', '2021-10-18 20:05:56', 'nwsa@dsa.rs'),
	(10, 'udsafg3451', '$2b$11$Ki/KRroWE5c3boANCUBug.x08raE9tbGXPoIqwoqx12WHAgmH3f7W', '2021-10-18 20:07:56', 'nfajkbfdsajkb@sa.rs'),
	(12, 'nneki user broj r2', '$2b$11$EUmxCoE7ftJu1x0apr1VNOQ0FfEeWbEYMVb7jTk8/ARmYmt2y87RC', '2021-10-18 20:08:30', 'nassda@adsa.rs');
